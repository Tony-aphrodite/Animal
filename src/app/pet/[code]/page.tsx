  ...
  const handleContact = () => {
    ...
    if (pet.contactType === 'WHATSAPP') {
      const message = encodeURIComponent(
        `Olá! Encontrei seu pet ${pet.name || ''}. Escaneei o QR Code PIPO na coleira dele.`
      )
  ...
  return (
    <div className="min-h-screen bg-[#EEF2F7]">
      ...
      {isOwner && pet && (
        <div className="bg-pipo-green-light border-b border-pipo-green/20">
          <div className="max-w-lg mx-auto px-4 py-2 flex items-center justify-between">
            <span className="text-sm text-gray-700">Este é seu pet</span>
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        {/* Title */}
        <h1 className="text-xl font-bold text-gray-800 mb-6">Informações do Pet & Contato</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="text-center px-6 pb-4">
            <h2 className="text-2xl font-bold text-gray-800">{pet.name || 'Desconhecido'}</h2>
            {petInfoString && (
          ...
          <div className="px-6 py-6 border-t border-gray-100">
            <div className="flex justify-center">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500">Pet identificado por QR Code • PIPO</p>
              </div>
            </div>
          </div>
        </div>
